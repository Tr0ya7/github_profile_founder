...
const UserProfile = (props: user) => {
    return (
        props.login !== undefined ? (
            <section className="bg-[#2b3566] p-[2rem] rounded-xl flex flex-col items-center justify-center gap-[1.2rem]">
                ...
                <Link className="text-center bg-[#644aff] p-[1rem] rounded opacity-80 duration-300 hover:opacity-100" href={`/repositores/${ props.login }`}>
                    Melhores projetos
                </Link>
            </section>
        ) : (
